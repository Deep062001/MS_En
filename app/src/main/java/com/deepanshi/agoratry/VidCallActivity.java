...
public class VidCallActivity extends AppCompatActivity {
    ...
    //[Hashmap to maintain ID's of dynamic frames that are created when a user joins the room so that video toggle effects can be performed
    // on that particular frames]
